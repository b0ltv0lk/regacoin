...
static const int64 MAX_MONEY = 5000000 * COIN; // REGA: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
static const int DIFF_FILTER_THRESHOLD_TESTNET =  1;
static const int DIFF_FILTER_THRESHOLD         = 1;
